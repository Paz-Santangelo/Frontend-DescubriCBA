...
function Quienes() {
  const equipo = [
    {
      nombre: "Yamil Alvarado",
      descripcion: "Profesora de Práctica profesionalizante",
      foto: Yamil,
    },
    {
      nombre: "María Roxana Mancuello",
      descripcion: "Desarrolladora FullStack",
      foto: Roxy,
    },
    {
      nombre: "Alejandro Santángelo",
      descripcion: "Desarrollador FullStack",
      foto: Alejandro,
    },
    {
      nombre: "María Paz Santángelo",
      descripcion: "Desarrolladora FullStack",
      foto: MariaPaz,
    },
  ];
    ...
    <div className="quienes-container">
      ...
      >
        <div className="overlay">
          <p>
            Somos estudiantes del Instituto Superior Dr. Bernardo Houssay,
            desarrolladores de la página web de turismo{" "}
            <strong>“Descubrí Córdoba”</strong>.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        style={{ backgroundImage: `url(${EquipoFondo})` }}
      >
        <div className="overlay">
          <p className="descripcion-equipo">
            Nuestro objetivo es brindar información clara y atractiva sobre los
            destinos de la provincia, facilitando la experiencia de quienes nos
            visitan.
          </p>
          <div
            id="equipoCarousel"
