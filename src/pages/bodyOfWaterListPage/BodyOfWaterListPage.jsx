...
const BodyOfWaterListPage = () => {
  ...
  return (
    <div className={`body-of-water-list-container ${isLoggedIn ? "logged-in" : ""}`}>
      <Container>
      ...
      {loading && (
        <div className="text-center">
          <Spinner animation="border" style={{ color: '#4ecdc4', width: '3rem', height: '3rem' }} />
        </div>
      )}
      ...
      {!loading && !error && bodiesOfWater.length === 0 && (
        <Alert variant="info">No se encontraron paseos para esta localidad.</Alert>
      )}
            ...
            >
              <Link to="#" className="text-decoration-none">
                <Card className="body-of-water-card h-100">
                  <Card.Img 
                    variant="top" 
                    src={bodyOfWater.imagesDestinations && bodyOfWater.imagesDestinations.length > 0 ? bodyOfWater.imagesDestinations[0].urlImage : 'https://via.placeholder.com/400x250'} 
